  ...
  return (
    <>
      ...
      <p>
        {" "}
        My{" "}
        <a href="https://linkedin.com/in/aaryanxshah" target="_blank">
          LinkedIn
        </a>{" "}
        is mostly updated with my professional experience. I am finishing my BS in Computer Science and MS in Biomedical
        Data Science at Stanford. I am currently working at Canvas Medical as an engineer on the Applied AI team,
        working on agentic capabilities and clinical-grade AI governance within our EHR.{" "}
      </p>
      <p>
        {" "}
        When designing this page, I was in the middle of{" "}
        <a href="https://www.stripe.press/poor-charlies-almanack" target="_blank">
      ...
      <h2>
        ...
        for all work experiences, most notable below){" "}
      </h2>
      <p>
      ...
      |{" "}
      <a href="https://scholar.google.com/citations?user=sfw7ATcAAAAJ&hl=en&oi=ao" target="_blank">
        Google Scholar
      </a>
      <hr />
